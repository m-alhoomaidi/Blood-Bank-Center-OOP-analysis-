...
class ProviderRepository extends BaseRepo_1.BaseRepository {
    constructor(dbConnection) {
        const repo = dbConnection.getRepository(Provider_1.Provider);
        super(dbConnection, repo);
    }
    getByAccountId(accountId, relations) {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield this.repository.findOne({
                where: { accountId },
                relations,
            });
            return provider;
